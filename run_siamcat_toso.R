...
option_list <- list(
  ...
  make_option(c("-a", "--train_dataset_name"), type = "character", default = "",
              help = "Train dataset name for toso", metavar = "character"),
  make_option(c("-b", "--test_dataset_name"), type = "character", default = "",
              help = "Tets dataset name for toso", metavar = "character"),
...
split_type <- 'toso'
train_dataset_name <- opt$train_dataset_name
...
output_file <- paste0(output_folder, split_type, "_", disease, "_", train_dataset_name,
                        "_train_", test_dataset_name, "_test.csv")
